  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (title) {
        ...
        await axios.post(`http://localhost:3001/textbook`, {
          ...formData,
          email,
        });
      }
      navigate("/publications");
      alert("Text Book Submitted Successfully!");
    } catch (error) {
      ...
      <MainContent>
        <ContentWrapper>
          <Form onSubmit={handleSubmit}>
            <Column>
              <TextBookDetailsSection>
                <TextBookDetailsWrapper>
                  <Column>
                    <TextBookDetailsContent>
                      <TextBookDetailHeading>
                        Title of the Book
                      </TextBookDetailHeading>
                      <TextBookDetailHeading>Authors</TextBookDetailHeading>
                      <TextBookDetailHeading>Publisher</TextBookDetailHeading>
                      <TextBookDetailHeading>DOI</TextBookDetailHeading>
                      <TextBookDetailHeading>Year</TextBookDetailHeading>
                      <TextBookDetailHeading>ISBN/ ISSN</TextBookDetailHeading>
                    </TextBookDetailsContent>
                  </Column>
                  <Column>
                    <TextBookDetailsInputs>
                      <React.Fragment>
                        <InputField
                          type="text"
                          name="title"
...
const TextBookImage = styled.img`
  position: absolute;
  inset: 0;
  z-index: -1;
  height: 100%;
...
const TextBookDetailsSection = styled.section`
  margin-top: 9px;
  flex-grow: 1;
  @media (max-width: 991px) {
    max-width: 100%;
...
const TextBookDetailsWrapper = styled.div`
  display: flex;
  gap: 20px;
  // width: 20%;
  @media (max-width: 991px) {
...
const TextBookDetailsContent = styled.div`
  // display: flex;
  margin-top: 4px;
  flex-grow: 1;
  flex-direction: column;
...
const TextBookDetailHeading = styled.h4`
...
const TextBookDetailsInputs = styled.div`
  display: flex;
  height: 15vh;
  // margin-left: 150px;
  flex-grow: 1;
